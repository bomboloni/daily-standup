...
// P - two arrays, one  that may have a number missing
// R - either the missing number or 0
// E - see  console logs
// P - filter, checking if an element from the first array is in the second
//   - return the missing number or 0

// function findMissing(arr, mixedArr) {
...
console.log(
  findMissing([1, 2, 3, 4, 5, 6, 7, 8, 9], [5, 7, 6, 9, 4, 8, 1, 2, 3]),
  0
)
